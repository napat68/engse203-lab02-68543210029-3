...
โปรเจกต์นี้เป็นส่วนหนึ่งของ Lab 02 ในรายวิชา ENGSE203 (Modern JavaScript) มีวัตถุประสงค์เพื่อฝึกพัฒนาเว็บ Dashboard ด้วย JavaScript สมัยใหม่ โดยนำแนวคิด ES Modules มาใช้แบ่งหน้าที่ของโปรแกรมออกเป็นโมดูลย่อย
...
<h3 style="color: green;">Normal State</h3>
...
![Normal State](screenshots/normal-state.png)

> **คำอธิบาย:** หน้าจอ Dashboard ในสถานะปกติ หลังจากระบบดึงข้อมูลและแสดงรายการทั้งหมดเรียบร้อยแล้ว  
>
> **URL:** https://napat68.github.io/engse203-lab02-68543210029-3/

---

<h3 style="color: red;">Error State</h3>
...
>
> **URL:** https://napat68.github.io/engse203-lab02-68543210029-3/?simulateError=1
